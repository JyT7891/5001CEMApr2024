...
def sign():
    ...
    global insert_username, insert_password, insert_email, gender_type_combobox, blood_type_var
    ...
    insert_username.place(x=380, y=195)

    password = Label(patient_sign_up, text="Password    :", font=('Arial', 20))
    password.place(x=200, y=290)
