...
def initialize_home_page(username):
    ...
    def open_profile():
        ...
        try:
            ...
            Label(profile_data_frame, text="Age             : ", font=('Helvetica', 15), bg='white').grid(row=3,
                                                                                                          ...
                                                                                                          padx=5,
                                                                                                          pady=5)
            age_entry = Entry(profile_data_frame, font=('Helvetica', 15), width=15)
            age_entry.grid(row=3, column=1, padx=5, pady=5)
            age_entry.insert(0, patient_info['age'])

            Label(profile_data_frame, text="Email           : ", font=('Helvetica', 15), bg='white').grid(row=4,
                                                                                                          column=0,
                                                                                                          sticky='w',
                                                                                                          padx=5,
                                                                                                          pady=5)
            ...
            Label(profile_data_frame, text="Password    : ", font=('Helvetica', 15), bg='white').grid(row=5, column=0,
                                                                                                      sticky='w',
                                                                                                      padx=5,
                                                                                                      pady=5)
    ...
    def contact_us():
        ...
        Label(contact_frame, text="Name          : ", font=('Helvetica', 12), bg='white').grid(row=0, column=0, padx=10, pady=10)
        name_entry = Entry(contact_frame, font=('Helvetica', 12), width=30)
        name_entry.grid(row=0, column=1, padx=10, pady=10)

        Label(contact_frame, text="Email          : ", font=('Helvetica', 12), bg='white').grid(row=1, column=0, padx=10, pady=10)
