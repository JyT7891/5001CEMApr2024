...
def initialize_home_page(username):
    ...
    def book_appointment():
        ...
        def button_command(event, clinic_name):
            home_page.withdraw()
        ...
        for idx, clinic in enumerate(clinics):
            ...
            clinic_frame = Frame(scrollable_frame, bd=2, relief="groove", padx=10, pady=10, bg="#f0f0f0",
            ...
            clinic_frame.bind("<Button-1>",
                              lambda event, clinic_name=clinic['name']: button_command(event, clinic_name))
    ...
    def about_us():
        ...
        # Display the book appointment content
        text = Label(content_area, text="About Us", font=('Helvetica', 25), background="white")
        text.pack()

        about()

    def about():
        about_frame = Frame(content_area, background="white")
        about_frame.pack(padx=50, pady=20)

        about_name = Label(about_frame, text="Name         :", justify=LEFT, background='#ADD8E6',
                           font=('Helvetica', 15))
        about_name.pack()
        insert_about_name = Entry(about_frame, width=30, font=('Arial', 19))
        insert_about_name.place(x=380, y=410)

        about_email = Label(about_frame, text="Email         :", justify=LEFT, background='#ADD8E6',
                            font=('Helvetica', 15))
        about_email.pack()
        insert_about_email = Entry(about_frame, width=30, font=('Arial', 19))
        insert_about_email.place(x=380, y=410)
    ...
    create_button("About Us", about_us)
