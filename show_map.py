...
import sys
from run_script import show_clinic_patient, run_script1
...
def book_now_and_close(clinic_id, username):
    clinic_map.destroy()
    show_clinic_patient("user_appointment.py", clinic_id, username)
...
if __name__ == "__main__":
    ...
    cancel = tk.Button(clinic_map, text="Cancel Book", font=('Helvetica', 10), command=cancel_book)
    cancel.pack(pady=5)
