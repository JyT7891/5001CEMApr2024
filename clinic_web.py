...
calendar_label.place(x=100, y=250)

calendar = Calendar(clinic, selectmode='day', date_pattern='yyyy-mm-dd')
calendar.place(x=300, y=250)

# Time entry widgets
time_label = tk.Label(clinic, text="Select Time (HH:MM) :", font=('Helvetica', 14))
...
time_menu = Combobox(clinic, textvariable=time_var, values=time_options, state="readonly", width=10, font=('Helvetica', 12))
...
# Cancel Button
cancel_button = tk.Button(clinic, text="Cancel", command=run_script1("home_page.py"))
